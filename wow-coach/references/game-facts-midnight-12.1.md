...
Game-mechanic facts verified during coaching sessions for WoW **Midnight 12.1, Season 2** (Aug 2026). These correct stale assumptions; each was either confirmed in-game by Kris or settled from his own logs.

- **Enchant slots: back and wrist have NO enchants in Midnight** (Kris, in-game 2026-08-26). Head, shoulders, chest, legs, feet, rings, weapon DO (all seen with enchant_ids in his exports). Never flag back/wrist as missing enchants.
...
- **Summon Demonic Tyrant: 60s cooldown observed** (Tranqlock's own min recast intervals, 2026-08-26) — settles the 60-vs-90s guide conflict for his build.
